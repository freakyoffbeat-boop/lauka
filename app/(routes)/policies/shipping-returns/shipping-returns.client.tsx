...
const SHIP_CARDS = [
  {
    ...
    title: "Processing",
    body:
      "Orders placed before 3 PM IST ship the same/next business day. Customized builds take 2–4 extra days.",
  },
  {
    icon: "📦",
    title: "Domestic Delivery",
    body:
      "Standard India delivery: 3–7 business days. Express options appear at checkout for eligible pincodes.",
  },
  {
    icon: "🌍",
    title: "International",
    body:
      "We ship select kits internationally. Transit 6–12 business days. Duties/taxes are payable by recipient.",
  },
];
...
const MINI_FAQ = [
  {
    ...
    a: "Yes, within ~2 hours of placing the order. Message us on WhatsApp with your Order ID and the corrected address.",
  },
  {
    q: "My order is delayed — what do I do?",
    a: "Paste your Order ID on our Support page or ping us on WhatsApp. We'll escalate with the courier and update you.",
  },
  {
    q: "I received a damaged kit.",
    a: "Snap a quick photo of the outer box and the kit. Send it along with your Order ID — we’ll ship a replacement part/kit.",
  },
  {
    q: "How long do refunds take?",
    a: "Once your return is delivered and passed QC, refunds are initiated within 24–48 hours. Banks may take 3–5 days to reflect.",
  },
];
        ...
        <div key={i}>
          ...
          <AnimatePresence initial={false}>
            {open === i && (
              ...
              >
                <div className="px-4 md:px-5 pb-4 text-gray-700">{it.a}</div>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
  ...
  return (
    <main className="bg-white text-gray-900">
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 pt-16 pb-6">
        ...
        <h1 className="mt-4 text-4xl font-header">{policyText.headline}</h1>
        <p className="mt-2 text-gray-600 max-w-3xl">{policyText.sub}</p>
      ...
      {/* Tiny voxel grid band */}
      <div className="mc-grid h-4 w-full" />

      {/* Cards: Processing / Domestic / International */}
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 pb-10">
        ...
        <p className="mt-3 text-sm text-gray-600">
          * Estimated times exclude weekends/holidays and may vary based on pincode,
          weather, or courier load. You’ll receive tracking via email after dispatch.
        </p>
      </section>
            ...
            <div className="p-6 md:p-7">
              ...
              <div className="mt-5 rounded-xl bg-amber-50 border border-amber-200 p-4 text-sm">
                ...
                <p className="text-gray-700">
                  Send clear photos of the outer box and affected parts within 48 hours of
                  delivery. We’ll ship exact replacements fast.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Cancellations / Refund Timelines */}
      <section className="mx-auto max-w-6xl px-4 md:px-6 pb-10">
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5">
            <div className="text-2xl">⏱️</div>
            <div className="mt-2 font-semibold">Order Changes & Cancellation</div>
            <p className="mt-1 text-sm text-gray-700">
              Edits/cancellations are possible within ~2 hours of purchase (before
              dispatch). After that, we can try but can’t guarantee a change with the
              courier.
            </p>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5">
            <div className="text-2xl">💳</div>
            <div className="mt-2 font-semibold">Refund Speed</div>
            <p className="mt-1 text-sm text-gray-700">
              After QC at our facility, refunds are initiated within 24–48 hours. Banks
              typically reflect the amount within 3–5 business days.
            </p>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5">
            <div className="text-2xl">🧾</div>
            <div className="mt-2 font-semibold">Customs & Duties</div>
            <p className="mt-1 text-sm text-gray-700">
              For international orders, local duties/taxes are the responsibility of the
              recipient. Our team will help with documentation where possible.
            </p>
          </div>
        </div>
      </section>
