...
const MINI_FAQ = [
  ...
  { q: "How long do refunds take?", a: "Once your return is delivered and passed QC, refunds are initiated within 24–48 hours. Banks may take 3–5 days to reflect." },
];
    ...
    <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 bg-white">
      {items.map((it, i) => (
        <div key={it.q}>
          ...
          {open === i && <div className="px-4 md:px-5 pb-4 text-gray-700">{it.a}</div>}
        </div>
      ))}
    </div>
  );
...
export default function ShippingReturnsClient() {
  const policyText = useMemo(
    () => ({
      ...
      sub: "Everything you need to know about processing times, delivery windows, returns, and refunds for Lauska magnetic blocks.",
    }),
    []
  );
    ...
    <main className="bg-white text-gray-900">
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 pt-16 pb-6">
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          ...
          <Link href="/faq" className="pixel-btn bg-white border border-gray-300 hover:bg-gray-50">
            ❓ FAQs
          </Link>
        </div>
      </section>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5">
            ...
            <p className="mt-1 text-sm text-gray-700">
              Edits/cancellations are possible within ~2 hours of purchase (before dispatch).
              After that, we can try but can’t guarantee a change with the courier.
            </p>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5">
            ...
            <p className="mt-1 text-sm text-gray-700">
              After QC at our facility, refunds are initiated within 24–48 hours.
              Banks typically reflect the amount within 3–5 business days.
            </p>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5">
            <div className="text-2xl">🧾</div>
            ...
            <p className="mt-1 text-sm text-gray-700">
              For international orders, local duties/taxes are the responsibility of the recipient.
              Our team will help with documentation where possible.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 pb-16">
        ...
        <SimpleAccordion items={MINI_FAQ} />
